...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  return (
    ...
    >
      <PromptInputTextarea placeholder={placeholder} className="text-wellness-text placeholder:text-wellness-muted" />
      <PromptInputActions className="px-2">
        <Button
          variant="ghost"
          size="icon"
          onClick={handleSubmit}
          disabled={isLoading || !input.trim()}
          className="bg-wellness-primary hover:bg-wellness-primary/90 text-wellness-primary-foreground"
        >
