...
import { Paperclip, Square, X, StopCircle, Send } from "lucide-react"
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const {
    onSend = () => {},
    isLoading = false,
    placeholder = "Check in with your wellness companion...",
    className,
          ...
          >
            <Button
              ...
              onClick={() => {
                ...
                else if (!disableVoiceRecording) setIsRecording(true)
              }}
            ...
            >
              {isLoading ? (
                ...
                <Send className={cn("h-5 w-5 transition-all", hasContent ? "text-[#1F2023]" : "text-[#9CA3AF]")} />
              )}
            </Button>
          </PromptInputAction>
        </PromptInputActions>
